...
\cite{Teschke2002}\cite{Bourgkard2013}\cite{Cherrie1999}\cite{Rake2009}\cite{Gilham2016} This allows too the examination of `exposure-response' relationships, entirely lacking in the published literature. 
...
ratio equals 1 with beta = 0.2 and alpha = 0.05; my planned sample size includes a margin for model stability
and incomplete data.
...
\includepdf[pages={1-10}]{ipfjes-sop.pdf}
\newpage
