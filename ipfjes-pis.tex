...
\lfoot{IPF JES}
\cfoot{Participant Information Sheet v0.4 \hspace{1cm} \today}
...
\item We will tell you what we find. What we find might not contain any helpful information for you. If we find anything we think is important we also, with your permission, inform your clinical team.
\end{itemize}
...
IPF is a rare disease. It is not a disease that normally runs in families but it is more common in people with certain genetic differences, such as a small change that affects mucus in our airways (called MUC5B rs35705950). A blood test helps us to check if it is workplace environments together with these genetic differences that causes IPF.   
