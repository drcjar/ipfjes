...
To meet GCP and HTA requirements the local team will maintain a local site study file. The local site file contains:
 ...
 \begin{enumerate}
     ...
     \item participation log (ipfjes-plog.csv)
     \item sample log (ipfjes-slog.csv)
     \item adverse event log (ipfjes-alog.csv)
     \item general notes (ipfjes-general-notes.txt)
