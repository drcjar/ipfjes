...
%DIF DEL ipfjes-protocol.tex           Fri Sep 29 10:54:15 2017
%DIF ADD ../docs/ipfjes-protocol.tex   Fri Sep 29 10:59:12 2017
...
\lfoot{IPFJES}
\cfoot{Study Protocol v0.5 \hspace{2cm} 7th August, 2017}
...
\subsection{Exclusion criteria}
 ...
 \item Cases  \begin{itemize} 
  ...
  \item Controls  \begin{itemize} 
        \item Unable to give informed consent
        \item \DIFdelbegin \DIFdel{Ever worked }\DIFdelend \DIFaddbegin \DIFadd{Worked }\DIFaddend outside of the UK \DIFaddbegin \DIFadd{for one year or more }\DIFaddend (does not include work outside the UK by memember of the armed forces or merchant navy)
        \end{itemize} 
