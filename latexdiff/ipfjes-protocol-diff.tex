...
%DIF DEL ipfjes-protocol.tex      Tue Jul 11 10:33:51 2017
%DIF ADD ../ipfjes-protocol.tex   Tue Jul 11 09:46:01 2017
...
%DIF < \lfoot{IPF JES}
%DIF < \cfoot{Study Protocol v0.4 \hspace{2cm} \today}
%DIF -------
\rhead{clinicaltrials.gov: NCT03211507} %DIF > 
\lfoot{IPFJES} %DIF > 
\cfoot{Study Protocol v0.5 \hspace{2cm} \today} %DIF > 
%DIF -------
...
\begin{centering}
\subsection*{Version \DIFdelbegin \DIFdel{0.4 }\DIFdelend \DIFaddbegin \DIFadd{0.5 }\DIFaddend \\ \today}
\end{centering}
...
\subsection{Exclusion criteria}
 ...
 \item Cases  \begin{itemize} 
        ...
        \item Ever worked outside of the UK \DIFaddbegin \DIFadd{(does not include work outside the UK by memember of the armed forces or merchant navy)
...
\includepdf[pages={1-4}]{ipfjes-pis-diff.pdf}	

\section{Participant consent form}
\includepdf[pages={1}]{ipfjes-consent.pdf}
\newpage

\DIFdelbegin \section{\DIFdel{Hospital specialist cover letter (case recruitment)}}
%DIFAUXCMD
\addtocounter{section}{-1}%DIFAUXCMD
%DIFDELCMD < \includepdf[pages={1}]{ipfjes-coverletter-cons-case.pdf}
%DIFDELCMD < \newpage
%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdelend \section{Hospital specialist cover letter (control recruitment)}
\includepdf[pages={1}]{ipfjes-coverletter-cons-control.pdf}
\DIFdelbegin %DIFDELCMD < \newpage
%DIFDELCMD < 

%DIFDELCMD < %%%
\section{\DIFdel{Participant cover letter}}
%DIFAUXCMD
\addtocounter{section}{-1}%DIFAUXCMD
%DIFDELCMD < \includepdf[pages={1}]{ipfjes-coverletter-pt.pdf}
%DIFDELCMD < %%%
\DIFdelend \newpage
...
\includepdf[pages={1-6}]{ipfjes-sop-diff.pdf}
\newpage
